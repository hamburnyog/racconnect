...
Future<String?> generateExcel(
  ...
  try {
    ...
    _generateExcelHeader(sheet, profile, selectedDate);

    final bodyData = _generateExcelBody(
      sheet,
      selectedDate,
      monthlyAttendance,
      holidayMap,
...
Map<String, int> _generateExcelBody(
  Sheet sheet,
  DateTime selectedDate,
  List<AttendanceModel> monthlyAttendance,
  Map<DateTime, String> holidayMap,
  ...
  return {
    'totalLateUndertimeHours': totalLateUndertimeHours,
    'totalLateUndertimeMinutes': totalLateUndertimeMinutes,
...
void _generateExcelHeader(
  ...
  String monthYearText =
      'FOR THE MONTH OF ${monthName.toUpperCase()} ${selectedDate.year.toString()}';
